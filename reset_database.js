...
// This will drop all tables and recreate them with correct schema
...
const resetDatabase = async () => {
  ...
  try {
    ...
    console.log('🏗️  CREATING FRESH TABLES WITH CORRECT SCHEMA...');
    ...
    // Create order_items table with correct price column
    await client.query(`
    ...
    // Insert all products with correct pricing
    const products = [
    ...
    for (const product of products) {
      try {
        ...
        console.log(`✅ Product: "${product.name}" - ₦${product.price.toLocaleString()}`);
      } catch (error) {
    ...
    console.log('✅ Fresh database is ready for production!');
